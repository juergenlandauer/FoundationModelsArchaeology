...
NOTE: for using the Visual Large Language Models suggested in the article (Gemini-2.0-flash and GPT4.o), you *must* register with their providers (Google and OpenAI, resp.) to obtain API keys. See each notebook in the subfolders here for instructions.
